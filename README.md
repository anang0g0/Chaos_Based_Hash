...
ここでちょっと生意気ですがチャレンジ問題を出しておきます。
単一の文字ｂが入っているファイルをｂとします。
その時、出てくるハッシュ値は、

39d83ff077bfe1b42f84147296b592e2765ee6491c31a00a776935b7b7858896

です。
この出力と同じ出力を持つような別の文書（データ）を見つけてほしいです。
